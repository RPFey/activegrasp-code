'''
Codes are from:
https://github.com/UT-Austin-RPL/GIGA/src/vgn/ConvONets/common.py
'''
...
def normalize_coordinate(p, padding=0.1, plane='xz'):
    ''' 从 xyz 中提取对应平面的坐标 [-0.5, 0.5], 经过 padding 缩放到 [0, 1] 区间, 最后去除 outliers
...
def coordinate2index(x, reso, coord_type='2d'):
    ...
    '''
    x = (x * reso).long()  # tensor.long() is equivalent to tensor.to(torch.int64).
