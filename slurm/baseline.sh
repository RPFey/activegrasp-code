...
#SBATCH --output=./output/baseline/%x-%A_%a.out
#SBATCH --error=./output/baseline/%x-%A_%a.err
...
# sleep EPISODE * 2 seconds
sleep $((EPISODE_ID*2))

#source /mnt/kostas-graid/sw/envs/boshu/miniconda3/bin/activate grasp
source /mnt/kostas-graid/sw/envs/wen/miniforge3/bin/activate regrasp
