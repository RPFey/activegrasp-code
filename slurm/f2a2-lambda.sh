...
#SBATCH --exclude=kd-2080ti-1.grasp.maas,mp-2080ti-0.grasp.maas,dj-2080ti-0.grasp.maas,kd-2080ti-2.grasp.maas,kd-2080ti-3.grasp.maas,kd-2080ti-4.grasp.maas,ee-3090-0.grasp.maas,ee-3090-1.grasp.maas,enough-oryx.grasp.maas,al-l40s-0.grasp.maas
...
srun python src/kinova_control/kinova_control_py/curobo_controller.py \
    ...
    --H_lambda 0.0001 \
    --init_view 2 \
    --data_root ${ws}/f2a2-grasp/${GRASP_MODEL}_${ACTIVE}_score_grasp-bkgd1.5-1e4-g512/s${SEED}-ep${EPISODE_ID}/iter${SLURM_ARRAY_TASK_ID}
